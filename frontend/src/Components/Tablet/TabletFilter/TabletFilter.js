...
const TabletFilter = ({setIsVisible,filterData, setFilterData, filterQuery}) =>{
    return(
        <div className="tablet_filter">
            <div className="tablet_filter_cors" onClick={()=>setIsVisible(false)} >
                <svg xmlns="http://www.w3.org/2000/svg" width="30.347" height="30.347" viewBox="0 0 30.347 30.347">
            ...
            <div className="tablet_filter_container">
                
                <div className="tablet_filter_col1">
                    <div>
                ...
                <div className="tablet_filter_col2">
                    <div>
                        <FormControl fullWidth>
                    ...
                    <div>
                        ...
                        <FormControl fullWidth>
                            <InputLabel id="main_camera">Main Camera</InputLabel>
                            <Select
                                label="Main Camera"
                                labelId="main_camera"
...
*/}
            ...
            <div className="tablet_filter_submit">
