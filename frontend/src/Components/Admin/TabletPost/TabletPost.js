...
const TabletPost = ({setState}) => {
  ...
  const onSubmit =data=>{
    ...
    axios.post('http://localhost:5000/api/v1/tablet',data)
    .then(res=>{
    ...
    {/* <form onSubmit={()=>handleSubmit(onSubmit)}> */}
        ...
        <div className="part2_details flex">
          ...
          <div className="part2_details_subheading">
            ...
            <div className="add_margin">
              ...
              <FormControl fullWidth>
                            <InputLabel id="main_camera"> Search Main Camera</InputLabel>
                            <Select
                                label="Search Main Camera"
                                labelId="main_camera"
                                {...register("search_rear_camera")}
                            >
            ...
            <div className="add_margin">
              {/* <TextField {...register("front_camera")} label="Front Camera" variant="outlined" placeholder="Ex: 8 MP" fullWidth/> */}
              <FormControl fullWidth>
                            <InputLabel id="front_camera"> Search Front Camera</InputLabel>
                            <Select
                                label="Search Front Camera"
                                labelId="front_camera"
                                {...register("search_front_camera")}
                            >
                                <MenuItem value="8 MP">8 MP</MenuItem>
                                <MenuItem value="IOS">IOS</MenuItem>
                            </Select>
      ...
      <div className="part5">
        <div className="part2_details flex">
          ...
          <div className="part2_details_subheading">
            ...
            <div className="add_margin">
              <TextField {...register("screen_to_body_ratio")} label="Screen to Body Ratio (calculated)" variant="outlined" placeholder="Ex: 83.45 %" fullWidth/>
        ...
        <div className="part2_details flex">
          ...
          <div className="part2_details_subheading">
            <div>
              ...
              <div className="add_margin">
                  <TextField {...register("rare_camera_setup")} label="Camera Setup" variant="outlined" placeholder="Quad" fullWidth/>
        
              </div>
            <div className="add_margin">
              <TextField {...register("rare_resolution")} label="Resolution" variant="outlined" placeholder="50 MP f/1.8 Primary Camera 8 MP f/2.2, Wide Angle, Ultra-Wide Angle Camera 2 MP f/2.4, Macro Camera (1.75µm pixel size) 2 MP f/2.4, Depth Camera(1.75µm pixel size)" fullWidth/>
            ...
            <div className="add_margin">
              <TextField {...register("rare_video_recording")} label="Video Recording" variant="outlined" placeholder="1920x1080 @ 30 fps 1280x720 @ 30 fps" fullWidth/>
            ...
            <div>
              ...
              <div className="add_margin">
                <TextField {...register("front_video_recording")} label="Video Recording" variant="outlined" placeholder="1920x1080 @ 30 fps 1280x720 @ 30 fps" fullWidth/>
            
              </div>
              <div className="add_margin">
                <TextField {...register("front_camera_setup")} label="Camera Setup" variant="outlined" placeholder="Single" fullWidth/>
            
              </div>
              <div className="add_margin">
                <TextField {...register("front_resolution")} label="Resolution" variant="outlined" placeholder="8 MP f/2.0 Primary Camera" fullWidth/>
      ...
      <div className="part9">
        <div className="part2_details flex">
          ...
          <div className="part2_details_subheading">
            <div className="add_margin">
              {/* <TextField {...register("internal_memory")} label="Internal Memory" variant="outlined" placeholder="64 GB" fullWidth/> */}

              <FormControl fullWidth>
                            <InputLabel id="internal_memory">Internal Memory</InputLabel>
                            <Select
                                label="Internal Memory"
                                labelId="internal_memory"
                                {...register("internal_memory")}
            ...
            <div className="add_margin">
              <TextField {...register("expandable_memory")} label="Expandable Memory" variant="outlined" placeholder="Yes, Up to 512 GB" fullWidth/>
      ...
      <div className="part10">
        <div className="part2_details flex">
          ...
          <div className="part2_details_subheading">
            <div className="add_margin">
            <FormControl fullWidth>
                            <InputLabel id="sim_support">Search Sim Support</InputLabel>
                            <Select
                                label="Sim Support"
                                labelId="sim_support"
                                {...register("search_sim_slot")}
                              >
            ...
            <div className="add_margin">
            <FormControl fullWidth>
                  <InputLabel id="network_type">Search Network Type</InputLabel>
                  <Select
                      label="Search Network Type"
                      labelId="network_type"
                      {...register("search_network_support")}
                  >
            ...
            <div className="add_margin">
              <TextField {...register("wi-fi")} label="Wi-Fi" variant="outlined" placeholder=" Yes, Wi-Fi 802.11, a/ac/b/g/n/n 5GHz" fullWidth/>

              
            </div>
            <div className="add_margin">
              <TextField {...register("wi-fi_features")} label="Wi-Fi Features" variant="outlined" placeholder="Mobile Hotspot" fullWidth/>
