...
const MobilePost = ({setState}) => {
  ...
  const onSubmit =async data=>{
    ...
    axios.post(`http://localhost:5000/api/v1/mobile`,data)
    .then(res=>{
  ...
  return (
    ...
    {/* <form onSubmit={()=>handleSubmit(onSubmit)}> */}
      ...
      <div className="part2">
        ...
        <div className="part2_details flex">
          ...
          <div className="part2_details_subheading">
            ...
            <div className="add_margin">
              {/* <TextField  label="Battery" variant="outlined" placeholder="Ex: 5000 mAh" fullWidth/> */}
              <FormControl fullWidth>
      ...
      <div className="part3">
        <div className="part2_details flex">
          ...
          <div className="part2_details_subheading">
            ...
            <div className="add_margin">
              {/* <TextField {...register("os")} label="Operating System" variant="outlined" placeholder="Ex: Android" fullWidth/> */}
                        <FormControl fullWidth>
      ...
      <div className="part8">
        <div className="part2_details flex">
          ...
          <div className="part2_details_subheading">
            ...
            <div className="add_margin">
              <TextField {...register("usb_type_c")} label="USB Type-C" variant="outlined" placeholder="Yes" fullWidth/>
      ...
      <Button onClick={handleSubmit(onSubmit)} variant="contained" color="success" >Submit Data</Button>
      {/* </form> */}
