...
const MobileFilter = ({setIsVisible,filterData, setFilterData, filterQuery}) =>{
  
    return(
        <div className="mobile_filter">
            <div className="mobile_filter_cors" onClick={()=>setIsVisible(false)} >
            ...
            <div className="mobile_filter_container">
                ...
                <div className="mobile_filter_col1">
                    <div>
                ...
                <div className="mobile_filter_col2">
                    <div>
                        <FormControl fullWidth>
...
*/}
            ...
            <div className="mobile_filter_submit">
